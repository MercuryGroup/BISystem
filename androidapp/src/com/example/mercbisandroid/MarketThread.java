...
protected ArrayList<Object> doInBackground(ArrayList<Object>... params) {
         ...
         String jsonLine = "";
         String line = "";
         String RealUrl = "http://mercury.dyndns.org:5984/mercury/_design/bi/_view/"+ MainActivity.Market +"?startkey=%22"+ MainActivity.MarketTime +"%22&endkey=%22"+ System.currentTimeMillis() + "%22";
